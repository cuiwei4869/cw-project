    ...
    <div>
        ...
        <div class="accessory-result-page accessory-page">
            ...
            <div class="filter-nav">
                ...
                <a @click="sortGoods" href="javascript:void(0)" class="price">Price <svg class="icon icon-arrow-short" v-bind:class="{'sort-up':sortFlag}">
            ...
            <div class="accessory-result">
                ...
                <div class="accessory-list col-4">
                    ...
                    <div class="loadMore" v-infinite-scroll="loadMore" infinite-scroll-disabled="busy" infinite-scroll-distance="25">
